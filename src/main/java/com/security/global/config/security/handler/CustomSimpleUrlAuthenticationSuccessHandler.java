package com.security.global.config.security.handler;

import com.security.domain.auth.application.CustomTokenProviderService;
import com.security.domain.auth.domain.Token;
import com.security.domain.auth.domain.repository.CustomAuthorizationRequestRepository;
...
import com.security.global.config.security.OAuth2Config;
import com.security.global.config.security.util.CustomCookie;
import com.security.global.error.DefaultAuthenticationException;
...
import static com.security.domain.auth.domain.repository.CustomAuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
